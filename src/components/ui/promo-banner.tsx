  ...
  return (
    ...
    >
      <div className="bg-gradient-to-r from-primary via-secondary to-accent py-3 px-4">
        ...
        <div className="container mx-auto flex items-center justify-center gap-2 md:gap-4 text-primary-foreground relative z-10">
          <motion.div
          ...
          <div className="flex flex-col md:flex-row items-center gap-1 md:gap-3 text-center">
            <span className="text-sm md:text-base font-bold flex items-center gap-2">
              <Zap className="w-4 h-4 hidden md:inline" />
              🎉 Grand Opening Offer
            </span>
          ...
          <motion.div
            ...
            className="flex items-center gap-1 text-xs md:text-sm font-medium bg-primary-foreground/20 px-2 md:px-3 py-1 rounded-full"
          >
